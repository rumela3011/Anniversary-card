var todayUser = firebase.database().ref("anniversary/");
...
var ratingGiven;
	if(noOfStars==='5')
		...
		firebase.database().ref('anniversary/'+phoneNumber).update({
		rating:newRating
			}).then(function() {
...
//	console.log(keys);
	for(var i=0;i<keys.length;i++){
		...
		li.innerHTML = usersData[key].mrname ;
		li.innerHTML = usersData[key].mrsname ;
