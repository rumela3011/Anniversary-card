const nameOfMr = document.getElementById('name');
const nameOfMrs = document.getElementById('name');
...
submit.addEventListener('click',(e) =>{
	...
	function(){
		...
		firebase.database().ref('anniversary/' +phone.value).set({
		birthday: dob.value.replaceAll("-","/"),
		mrname: nameOfMr.value,
		mrsname:nameOfMrs.value,
		place: city.value,
		emailId: email.value,
		phoneNo: phone.value,
